...
class OrderXML2JSON
{
	...
	public function filterArray(array $array) : array	// Convert any empty arrays to empty strings, build the downloadURLs and add them to the orderproducts elements
	{
	...
	//	$xml=simplexml_load_file($xmlFile);
		...
		//	
			...
			Logger::fine("domain set to $domain");
		...
		{	throw new ApplicationException("Invalid XML file, failed to convert to XML to JSON!");	}
	}
}
