...
class WS_XMP_ActualDelivery
{
	...
	function __construct(private array $cfgArray)
	{
		...
		$this->deliveryWS = new \SoapClient($url.'uStoreWSAPI/ActualDeliveryWS.asmx?WSDL', array('trace'   => true, 'exceptions'=> true));
	}
	...
	public function createDeliveryByOrderProducts(array $orderProductIdsArray, string $deliveryDateTime, string $trackingNumber='', float $deliveryPrice=0.0, int $deliveryServiceID=-1) : int
	{
